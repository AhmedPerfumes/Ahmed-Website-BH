...
const FreeGiftFeature = ({ couponData }) => {
  ...
  const getNextThresholdMessage = () => {
    ...
    if (nextThreshold) {
      return <span className='t-subtitle' style={{ color:'#c00000',fontSize: '18px', lineHeight: '1.5rem',textAlign: 'center' }}>Spend BHD {(nextThreshold.min - nonCollectionTotalPrice).toFixed(2)} more to unlock a free gift!</span>;
    }
