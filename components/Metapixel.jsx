        ...
        const loadFacebookPixel = () => {
            if (!window.fbq) {
                (function (f, b, e, v, n, t, s) {
                    ...
                    // ⚠️ MUST be called here — before the script tag loads —
                    // so it's queued in the fbq stub and processed when fbevents.js
                    // initialises. Calling it AFTER the script inject is too late.
                    f.fbq("set", "autoConfig", false, "909515767454411");
                    f.fbq("init", "909515767454411");
