...
const ProductSchema = ({ category, subcategory, product }) => {
  ...
  const jsonLd = {
      ...
      sku: product.sku,
      brand: { "@type": "Brand", name: "Ahmed Al Maghribi Perfumes Bahrain" },
      offers: {
          "@type": "Offer",
          priceCurrency: "BHD",
          price: product.price,
          url: `https://bh.ahmedalmaghribi.com/en/shop/${category}/${subcategory}/${product.product_name
              .split(" ")
              .join("-")
              .toLowerCase()}`,
          availability:
  ...
  try {
    ...
    return (
      ...
      <Head>
                    ...
                    <meta
                        property="og:url"
                        content={`https://bh.ahmedalmaghribi.com/en/shop/${categoryName}/${subCategoryName}/${data.product_name
                            .split(" ")
                            .join("-")
                            .toLowerCase()}`}
                    />
                    ...
                    <meta
                        ...
                        content="Ahmed Al Maghribi Perfumes Bahrain"
                    />
                </Head>
        <Header14 />
        <ProductSchema
